/*
    class common_utility, timers and timing
...
{
#ifdef DEBUG_TIMERS
    (void)snprintf(X_dstr, sizeof(X_dstr), DEBUG_TIMERS_FORMAT, __LINE__, __FILE__, __func__);
    debug_record(false);
#endif
...
double common_utility::timer_get_split_cpu()
{
    ...
    {
        this->report_status_code(CODEZ::_6_returned_initialized_value);
        #ifdef DEBUG_MAX
...
double common_utility::timer_get_split_wall()
{
    ...
    else
    {
        ...
        (void)this->report_status_code(CODEZ::_6_returned_initialized_value);
        this->_split_wall = INIT_DOUBLE;
        return this->_split_wall;
    }
}
...
/*
    < 8 > public
*/
double common_utility::timer_get_running_cpu()
{
#ifdef DEBUG_TIMERS
    (void)snprintf(X_dstr, sizeof(X_dstr), DEBUG_TIMERS_FORMAT, __LINE__, __FILE__, __func__);
    debug_record(false);
...
/*
    < 9 > public
*/
double common_utility::timer_get_running_wall()
{
#ifdef DEBUG_TIMERS
    (void)snprintf(X_dstr, sizeof(X_dstr), DEBUG_TIMERS_FORMAT, __LINE__, __FILE__, __func__);
    debug_record(false);
