/*
    ...
    public :
        < 1 >  h_batch_redir_insert_ext_change()
...
/*
    ...
    3) inserts desired test ... use h_batch_change_redirect() if no insersiton is needed
    3) concatenates desired output directory and files with changed extensions into "std::vector<std::string> new_filez"

    <new dir> <insert> <old file name> . <new extension>
*/
CODEZ common_utility::h_batch_redir_insert_ext_change
(
