...
CODEZ rsa306b_class::_ifstream_init()
{
    ...
    {
        strcpy(this->_vars.ifstream.acq_status_messages[ii], this->_vars.ifstream._ACQ_STATUS_MESSAGES);
    }
    ...
    strcpy(this->_vars.ifstream.file_name_base, this->_vars.ifstream._FILE_NAME_BASE);
    strcpy(this->_vars.ifstream.file_path, this->_vars.ifstream._FILE_PATH);
