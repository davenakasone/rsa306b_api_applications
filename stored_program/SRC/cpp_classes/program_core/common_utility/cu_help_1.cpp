...
static void get_byte(uint8_t byte, char* bstr, long int idx);    // for local assistance
...
static void get_byte(uint8_t byte, char* bstr, long int idx)
{
    switch (byte)
    {
