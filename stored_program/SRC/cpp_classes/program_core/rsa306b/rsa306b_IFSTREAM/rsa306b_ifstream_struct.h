...
*/          
    ...
    const int*              _DATA_INFO_TYPE_triggerIndices = NULL;           // DEFAULT
    const uint32_t          _DATA_INFO_TYPE_acqStatus      = INIT_UINT32;    // DEFAULT
...
*/ 
    ...
    const int _NUMBER_OF_SAMPLES = INIT_INT;    // DEFAULT
...
/*
    IFSTREAM_SetEnable()
        start or stop the IF streaming operation
            is_enabled ; true means that streaming should start | false means that streaming should stop
*/
    bool       is_enabled;
