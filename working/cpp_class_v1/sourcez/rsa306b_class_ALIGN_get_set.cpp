/*
    ...
    using "ALIGN" function group of the API
        ...
        private:
            # execute_alignment()
            # execute_warm_up()
        void _align_set_is_needed(bool new_value);
        void _align_set_is_warmed(bool new_value);
*/
...
*/
void rsa306b::_align_set_is_needed(bool new_value)
{
#ifdef DEBUG_CLI
    printf("\n<%d> %s/%s()\n",
...
////////~~~~~~~~END>  rsa306b_class_ALIGN_get_set.cpp
