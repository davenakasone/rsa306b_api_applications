/*
    ...
    see demo_1() to get batch processing going
*/
...
void demo_1()
{
    ...
    printf("\nthe file list is ready, %ld files found:\n", file_list.size());
    for (long unsigned int ii = 0; ii < file_list.size(); ii++)
    {
        printf("\t%s\n", file_list[ii].c_str());
    }
    ...
    manager.get_vars(&manager.members);
    printf("%d\n", manager.members.alignment_state);
    */
}
