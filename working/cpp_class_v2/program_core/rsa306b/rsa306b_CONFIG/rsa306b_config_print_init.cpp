...
void rsa306b_class::_config_init()
{
    ...
    this->_vars.config.reference_level_dbm = this->_vars.constants.INIT_DOUBLE;   
    this->_vars.config.center_frequency_hz = this->_vars.constants.INIT_DOUBLE; 
    this->_vars.config.min_center_frequency_hz = this->_vars.constants.INIT_DOUBLE; 
    this->_vars.config.max_center_frequency_hz= this->_vars.constants.INIT_DOUBLE; 
    this->_vars.config.external_reference_frequency_hz = this->_vars.constants.INIT_DOUBLE;  
